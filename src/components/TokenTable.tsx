...
export function TokenTable({ data }: TokenTableProps) {
  return (
    <div className="relative bg-white rounded-lg shadow-sm border border-gray-100 mt-6 flex flex-col flex-grow overflow-x-auto overflow-y-auto">
      <table className="w-full">
        ...
        <tbody>
          {data.map((row, index) => (
            <tr key={index} className={clsx(index !== data.length - 1 && 'border-b border-gray-100')}>
